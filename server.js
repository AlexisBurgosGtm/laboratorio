...
app.post("/listado_clientes",function(req,res){
      ...
      if(st=='PENDIENTES'){
            if(filtro=='TODOS'){
              qry = `
              SELECT top 300 CLIENTES.CODEMPRESA, EMPRESAS.EMPRESA, CLIENTES.CODIGO, CLIENTES.DPI, CLIENTES.NOMBRE, CLIENTES.FECHA_NACIMIENTO, CLIENTES.AREA_TRABAJO AS AREA, CLIENTES.SECTOR, CLIENTES.TARJETA_SALUD AS SALUD, 
